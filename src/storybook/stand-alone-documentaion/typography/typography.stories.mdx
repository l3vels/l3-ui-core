...
<Canvas>
  <Story name="Label">
    <div style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
      <Typography value="label large" type="label" size="large" />
      <Typography value="label medium" type="label" size="medium" />
      <Typography value="label small" type="label" size="small" />
      <Typography value="label xs-small" type="label" size="xs-small" />
    </div>
  </Story>
</Canvas>
...
<Canvas>
  <Story name="Paragraph">
    <div style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
      <Typography value="paragraph large" type="paragraph" size="large" />
      <Typography value="paragraph medium" type="paragraph" size="medium" />
      <Typography value="paragraph small" type="paragraph" size="small" />
      <Typography value="paragraph xs-small" type="paragraph" size="xs-small" />
    </div>
  </Story>
</Canvas>
