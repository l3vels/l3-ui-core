...
<Meta
  title="Feedback/Loader - (Coming Soon)"
  component={Loader}
    ...
    <Flex direction={Flex.directions.ROW} gap={Flex.gaps.SMALL}>
      ...
      <StoryDescription description="OnPrimary" vertical align={Flex.align.START}>
        <Flex direction={Flex.directions.ROW}>
          <div className="l3-storybook-loader_color-variants_on-primary--color-black">
            <Loader size={Loader.sizes.MEDIUM} color={Loader.colors.ON_PRIMARY} />
          </div>
          <div className="l3-storybook-loader_color-variants_on-primary--color-negative">
            <Loader size={Loader.sizes.MEDIUM} color={Loader.colors.ON_PRIMARY} />
          </div>
          <div className="l3-storybook-loader_color-variants_on-primary--color-positive">
            <Loader size={Loader.sizes.MEDIUM} color={Loader.colors.ON_PRIMARY} />
          </div>
          <div className="l3-storybook-loader_color-variants_on-primary--color-primary">
            <Loader size={Loader.sizes.MEDIUM} color={Loader.colors.ON_PRIMARY} />
          </div>
        </Flex>
      </StoryDescription>
