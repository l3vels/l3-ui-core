...
<Canvas>
  <Story name="Overview"
         args={{ onClose: () => null, title: "Attention box title", text: "Studies show that 100% of people who celebrate birthdays, will eventually die.", className: "l3-style-attention-box_box" }}>
    ...
    <Flex direction={Flex.directions.COLUMN} gap={Flex.gaps.SMALL}>
      <StoryDescription description="Primary">
        <AttentionBox
          ...
          className="l3-style-attention-box_box"
          icon={Info}
        />
      </StoryDescription>
...
<Canvas>
  <Story name="Dismissable ">
    {() => { 
      ...
      return (
        <div className="l3-style-attention-box_row-wrapper">
          <AttentionBox 
...
<ComponentRules
  rules={[
    {
      positive: {
        component: <AttentionBox title="Attention box title" text="Studies show that 100% of people who celebrate birthdays, will eventually die." className="l3-style-attention-box_box"/>,
    ...
    },
    {
      positive: {
        component:
          <div>
            <span className="l3-style-attention-box_title">Inbox</span>
            <span className="l3-style-attention-box_text" >Catch up on updates from all your boards.</span>
            <AttentionBox text={<span className="l3-style-attention-box_info">Get your l3vels.xyz notifications<Link>Learn More</Link></span>} className="l3-style-attention-box_att-box"  />
          </div>,
      ...
      negative: {
        component:
          <div>
            <span className="l3-style-attention-box_title">Inbox</span>
            <span className="l3-style-attention-box_text" >Catch up on updates from all your boards.</span>
            <AttentionBox text={<span className="l3-style-attention-box_info">7 days left on your free trial <Link>Learn More</Link></span>} compact className="l3-style-attention-box_att-box" />
          </div>,
...
<Canvas>
  <Story name="Natural attention box">
    <div className="l3-style-attention-box_wrapper">
      <span className="l3-style-attention-box_title">Cross-Account Copier</span>
      <span className="l3-style-attention-box_text" >Copy boards and dashboards to another account</span>
      <AttentionBox
        compact
...
<Canvas>
  <Story name="Attention box inside a dialog/combobox">
    {() => { 
      const mockOnClose = useCallback(() => null, []);
      return (
        <DialogContentContainer className="l3-style-attention-box_search-bar">
          <Search placeholder="Search by name, role, team, or email" />
          <div className="l3-style-attention-box_lable">Suggested people</div>
          <div className="l3-style-attention-box_search">
            <div className="l3-style-attention-box_inline-container">
              <Avatar size={Avatar.sizes.MEDIUM} src={person} type={Avatar.types.IMG} />
              <span className="l3-style-attention-box_name">May Kishon <span>(UX/UI Product Designer)</span></span>
            </div>
            <div className="l3-style-attention-box_inline-container">
              <Icon iconSize="24" icon={Invite} className="l3-style-attention-box_icon" />
              <span className="l3-style-attention-box_name">Invite new board member by email</span>
            </div>
            <AttentionBox 
