  ...
  const classNames = useMemo(
    () =>
      cx(
        ...
        `l3-style-split-button--kind-${kind}`,
        `l3-style-split-button--color-${color}`,
        {
          "l3-style-split-button--main-active": active,
          "l3-style-split-button--active": isActive,
          "l3-style-split-button--split-content-open": isDialogOpen,
          "l3-style-split-button--hovered": isHovered,
          "l3-style-split-button--disabled": disabled
        },
        className
      ),
  ...
  return (
    <div className={classNames} ref={ref} role="button">
      <Button
        ...
        active={active}
        onClick={onClick}
        className="l3-style-split-button__main-button"
        ...
        <div className={SECONDARY_BUTTON_WRAPPER_CLASSNAME}>
          ...
          >
            <Button
              ...
              color={color}
              kind={kind}
              className="l3-style-split-button__secondary-button"
              active={isDialogOpen}
            ...
            >
              <div className="l3-style-split-button__secondary-button-icon-wrapper">
