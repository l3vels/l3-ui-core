...
<Canvas>
  <Story name="Rectangle avatar with border">
    <Avatar size={Avatar.sizes.SMALL} src={apes1} type={Avatar.types.IMG} borderColor="orange" rectangle />
    <Avatar size={Avatar.sizes.MEDIUM} src={apes5} type={Avatar.types.IMG} borderColor="orange" rectangle />
    <Avatar size={Avatar.sizes.LARGE} src={apes2} type={Avatar.types.IMG} borderColor="orange" rectangle />
  </Story>
</Canvas>
