...
import { AvatarsList } from "../avatar.stories.helperComponents";
...
<Canvas>
  <Story name="Rectangle avatar">
    <div style={{ display: "flex", gap: "50px" }}>
      <Avatar size={Avatar.sizes.XXS} src={monkey_5} type={Avatar.types.IMG} rectangle />
      <Avatar size={Avatar.sizes.XS} src={monkey_1} type={Avatar.types.IMG} rectangle />
      <Avatar size={Avatar.sizes.SMALL} src={avatar1} type={Avatar.types.IMG} rectangle />
      <Avatar size={Avatar.sizes.MEDIUM} src={avatar2} type={Avatar.types.IMG} rectangle />
      <Avatar size={Avatar.sizes.LARGE} src={avatar3} type={Avatar.types.IMG} rectangle />
    </div>
  </Story>
</Canvas>
...
<Canvas>
  <Story name="Rectangle avatar with border">
    <Avatar size={Avatar.sizes.SMALL} src={monkey_1} type={Avatar.types.IMG} borderColor="orange" rectangle />
    <Avatar size={Avatar.sizes.MEDIUM} src={monkey_5} type={Avatar.types.IMG} borderColor="green" rectangle />
    <Avatar size={Avatar.sizes.LARGE} src={monkey_2} type={Avatar.types.IMG} borderColor="pink" rectangle />
  </Story>
</Canvas>
  ...
  rules={[
    {
      positive: {
        component: (
          <div className="l3-style-story-avatar_multiple-reverse">
...
<Canvas>
  <Story name="Multiple avatars">
    <MultipleStoryElementsWrapper className="l3-style-story-avatar_multiple">
