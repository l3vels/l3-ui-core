...
<Meta
  title="Media/Avatar - (Coming Soon)/Avatar - (Coming Soon)"
  component={Avatar}
...
<Canvas>
  <Story name="Rectangle avatar">
    ...
    <Avatar size={Avatar.sizes.MEDIUM} src={avatar3} type={Avatar.types.IMG} rectangle />
    <Avatar size={Avatar.sizes.MEDIUM} src={avatar4} type={Avatar.types.IMG} rectangle />
  </Story>
</Canvas>
