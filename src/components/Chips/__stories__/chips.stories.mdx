...
<Canvas>
  <Story name="Sizes">
    <Chips label="Tag" size="large" />
    <Chips label="Tag" size="small" />
  </Story>
</Canvas>
...
<Canvas>
  <Story name="Outlined">
    <Chips label="Tag" size="large" outlined={true} />
    <Chips label="Tag" size="small" outlined={true} />
  </Story>
</Canvas>
  ...
  rules={[
    {
      ...
      negative: {
        component: <Chips label="This is a chip" className="l3-style-story-chips_chip-padding" readOnly />,
...
<Canvas>
  <Story name="Colorful chips for different content">
    <DialogContentContainer className="l3-style-story-chips_search-bar">
      <div className="l3-style-story-chips_item">
...
<Canvas>
  <Story name="Chips in Person Column">
    <DialogContentContainer className="l3-style-story-chips_search-bar">
      ...
      <div className="l3-style-story-chips_inline-container">
        <Chips label="Esther Schanler" />
        <Chips label="Itai Shabtai" />
      </div>
      <div className="l3-style-story-chips_lable">Suggested people</div>
      <div className="l3-style-story-chips_search">
        <div className="l3-style-story-chips_inline-container" key="cont-1">
          <Avatar size={Avatar.sizes.MEDIUM} src={person1} type={Avatar.types.IMG} />
          <span className="l3-style-story-chips_name">
            May Kishon <span>(UX/UI Product Designer)</span>
          </span>
        </div>
        <div className="l3-style-story-chips_inline-container" key="cont-2">
          <Avatar
        ...
        <div className="l3-style-story-chips_inline-container" key="cont-3">
          <Avatar size={Avatar.sizes.MEDIUM} text="DY" type={Avatar.types.TEXT} />
          <span className="l3-style-story-chips_name">
            Amanda Lawrence <span>(Customer Experience Designer)</span>
          </span>
        </div>
        <div className="l3-style-story-chips_inline-container" key="cont-4">
          <Avatar size={Avatar.sizes.MEDIUM} src={person1} type={Avatar.types.IMG} />
          <span className="l3-style-story-chips_name">
