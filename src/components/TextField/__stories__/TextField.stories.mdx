...
<Meta
  title="Inputs/TextField - (In Progress)"
  component={TextField}
...
<Canvas>
  <Story name="Sizes">
    <div className="l3-storybook-text-field_column-wrapper">
      <TextField placeholder="Small" iconName={CloseSmall} />
      <TextField placeholder="Meduim" size={TextField.sizes.MEDIUM} iconName={CloseSmall} />
      <TextField placeholder="Large" size={TextField.sizes.LARGE} iconName={CloseSmall} />
    </div>
  </Story>
</Canvas>
