  ...
  <Story name="Icon + Label">
    <div style={{ display: "flex", justifyContent: "space-evenly", alignItems: "center", width: "100%" }}>
      ...
      <IconButton
        ...
        ariaLabel="My IconLabel Button"
      />
      <IconButton label="label" icon={Close} kind={IconButton.kinds.PRIMARY} ariaLabel="My IconLabel Button" />
      <IconButton label="label" icon={Close} kind={IconButton.kinds.TERTIARY} ariaLabel="My IconLabel Button" />
    </div>
  </Story>
</Canvas>
...
<Canvas>
  <Story name="Active">
    <div style={{ display: "flex", justifyContent: "space-evenly", alignItems: "center", width: "100%" }}>
      <IconButton icon={Close} kind={IconButton.kinds.PRIMARY} ariaLabel="My active large IconButton" active />
      <IconButton icon={Close} kind={IconButton.kinds.SECONDARY} ariaLabel="My active medium IconButton" active />
      <IconButton icon={Close} kind={IconButton.kinds.TERTIARY} ariaLabel="My active large IconButton" active />
    </div>
  </Story>
</Canvas>
