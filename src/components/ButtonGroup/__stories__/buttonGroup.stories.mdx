...
<Meta
  title="Buttons/ Button Group - (In Progress)"
  component={ButtonGroup}
  ...
  <Story name="Disabled - Singe Button">
    <ButtonGroup
      ...
      options={[
        ...
        { value: 2, text: "Label" },
        { value: 3, text: "Label" },
        { value: 4, text: "Label", disabled: true, tooltipContent: "I'm the worst variant ever" }
      ]}
    />
  </Story>
</Canvas>
...
<Canvas>
  <Story name="Size">
    <div className="l3-storybook-button-group_column">
      Medium
      <ButtonGroup
        groupAriaLabel="button group aria label"
